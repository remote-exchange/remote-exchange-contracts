...
describe("base old tests", function () {
  ...
  it("deploy RemoteFactory and test pair length", async function () {
    const RemoteFactory = await ethers.getContractFactory("RemoteFactory");
    factory = await RemoteFactory.deploy();
    await factory.deployed();

    expect(await factory.allPairsLength()).to.equal(0);
  });

  it("deploy RemoteRouter01 and test factory address", async function () {
    const RemoteRouter01 = await ethers.getContractFactory("RemoteRouter01");
    router = await RemoteRouter01.deploy(factory.address, owner.address);
    await router.deployed();

    expect(await router.factory()).to.equal(factory.address);
  });

  it("deploy pair via RemoteFactory owner", async function () {
  ...
  it("deploy pair via RemoteFactory owner2", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
    const mim_1 = ethers.BigNumber.from("1000000000000000000");
    const dai_1 = ethers.BigNumber.from("1000000000000000000");
  ...
  it("RemoteRouter01 removeLiquidity", async function () {
    const ust_1000 = ethers.BigNumber.from("100000000000");
    const mim_1000 = ethers.BigNumber.from("100000000000000000000000");
    const mim_100000000 = ethers.BigNumber.from("100000000000000000000000000");
    const dai_100000000 = ethers.BigNumber.from("100000000000000000000000000");
  ...
  it("RemoteRouter01 addLiquidity owner2", async function () {
    const ust_1000 = ethers.BigNumber.from("100000000000");
    const mim_1000 = ethers.BigNumber.from("100000000000000000000000");
    const mim_100000000 = ethers.BigNumber.from("100000000000000000000000000");
    const dai_100000000 = ethers.BigNumber.from("100000000000000000000000000");
  ...
  it("RemoteRouter01 pair1 getAmountsOut & swapExactTokensForTokens", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
  ...
  it("RemoteRouter01 pair1 getAmountsOut & swapExactTokensForTokens owner2", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
    const route = {from: ust.address, to: mim.address, stable: true}
  ...
  it("RemoteRouter01 pair2 getAmountsOut & swapExactTokensForTokens", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
  ...
  it("RemoteRouter01 pair3 getAmountsOut & swapExactTokensForTokens", async function () {
  ...
  it("deploy RemoteVoter", async function () {
    ...
    const RemoteVoter = await ethers.getContractFactory("RemoteVoter");
    voter = await RemoteVoter.deploy(ve.address, factory.address, gauges_factory.address, bribe_factory.address);
  ...
  it("deploy Minter", async function () {
    ...
    const Minter = await ethers.getContractFactory("RemoteMinter");
  ...
  it("deploy RemoteFactory gauge", async function () {
  ...
  it("deploy RemoteFactory gauge owner2", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
  ...
  it("RemoteRouter01 pair1>pair2 getAmountsOut & swapExactTokensForTokens", async function () {
    const mim_1 = ethers.BigNumber.from("1000000000000000000");
    const route = [{from: mim.address, to: ust.address, stable: false}, {
      from: ust.address,
      to: mim.address,
  ...
  it("gauge claim rewards1", async function () {
    ...
    expect(received).to.be.below(earned.add(earned.div(100000)))
  ...
  it("RemoteRouter01 addLiquidity owner3", async function () {
  ...
  it("deploy RemoteFactory gauge owner3", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
